...
const EmpoyeeList = () => {
    ...
    return (
        <div className='container mx-auto my-8'>
            <div className='h-12 px-5'><button onClick={() => navigate("/addEmployee")} className='rounded bg-slate-600 text-white px-6 py-2 font-semibold'>Add Employee</button></div>
                ...
                <table className='min-w-full'>
                    <thead className='bg-grey-50'>
                        <tr>
                            ...
                            <th className='text-left font-medium text-grey-500 uppercase tracking-wider py-3 px-6'>Email Id </th>
                            <th className='text-left font-medium text-grey-500 uppercase tracking-wider py-3 px-6' >Actions</th>
                        </tr>
                    </thead>
                    {!loading && ( 
