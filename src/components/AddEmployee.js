        ...
        <div className='flex max-w-2xl shadow border-b mx-auto'>
            <div className="px-8 py-8">
                ...
                <div className="item-center justify-center h-14 w-full my-4 space-x-4 pt-4">
                    <button className="text-white font-semibold py-2 px-4 rounded bg-green-400  hover:bg-green-700">Save</button>
                    <button className="text-white font-semibold py-2 px-4 rounded bg-red-400  hover:bg-red-700">Clear</button>
                </div>
            </div>
        </div>
